...
layout = html.Div(
    style={ # temporary, will move to design.css later
        "maxWidth": "800px",
        "margin": "0 auto",
        "padding": "40px",
    ...
    children=[ # temporary, will adjust later
        html.H1(
        ...
        html.P(
            """
            Click through our pages to explore interactive charts, trends over time, 
